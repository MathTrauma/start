...
- 삼각형 GHO 의 꼭짓점 O 를 선분 ON 을 따라 N 으로 이동 최종 삼각형 GDN (duration : 1.5)
- delay  (duration : 0.5)
...
- PHASE 1에서 그려진 두 삼각형을 지우고 두 삼각형 DNG 와 DNH 을 투명한 파란색으로 채워서 동시에 그리기 (duration : 1.5)
- 두 삼각형에 effect 적용 (duration : 1.0)
- 삼각형 DNG 와 삼각형 DBC 위에 빛나는 원이 한바퀴 돔 (duration : 1.0) 
...
- 삼각형 GFC 와 삼각형 GFO 를 동시에 그리기 @ 0.3 (duration : 1.5)
- 삼각형 GFO 의 꼭짓점 O 를 선분 OM 을 따라 M 으로 이동 최종 삼각형 GDN @ 1.8 (duration : 1.5)
