...
import { XObject, XPolygon, XSegment, XPoint, XCircle, XRightAngle, XDimension, XAngleMarker, XText } from '../../lib/x_object.js';
...
const sketch = (p) => {
    ...
    p.setup = function () {
        ...
        const textAngle = new XText(p, [size / 2, 25], '\\angle O_1 B A = 30^\\circ', { useTex: true, fontSize: 18, screenCoord: true });
